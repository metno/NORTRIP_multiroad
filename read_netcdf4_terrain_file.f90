!read_netcdf_terrain_file.f90
    ...
    subroutine read_netcdf4_terrain_file(filename_nc_sub,ncols_sub,nrows_sub,cellsize_sub)
    
    use NORTRIP_multiroad_index_definitions
    !Update to netcdf 4 and 64 bit in this version 2 of read_netcdf_terrain_file
    use netcdf
    ...
    end subroutine read_netcdf4_terrain_file
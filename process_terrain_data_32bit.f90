!process_terrain_data.f90
    subroutine process_terrain_data_32bit
	...
	write(unit_logfile,'(A)') 'Calculating shading parameters (process_terrain_data_32bit)'
	write(unit_logfile,'(A)') '================================================================'
    ...
    do f=1,n_dem_files
        ...
        elseif (index(filename_ascii(f),'.nc').gt.0) then
            ...
            call read_netcdf3_terrain_file(filename_ascii(f),ncols,nrows,cellsize)
        else
...
20  enddo
    ...
    end subroutine process_terrain_data_32bit
